 ...
 * Página de Coleção
 * 
 * Exibe todos os sets de armadura na coleção do usuário
 */
  ...
  useEffect(() => {
    ...
    const fetchCollection = async () => {
      ...
      try {
        ...
        const setsArray = Array.isArray(collectionSets) ? collectionSets : [];
        setSets(setsArray);
  ...
  const handleToggleRelation = async (
    ...
    try {
      if (isActive) {
        ...
        // Se estava removendo da coleção e a página é de coleção, remove da lista
