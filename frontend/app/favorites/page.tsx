 ...
 * Página de Favoritos
 * 
 * Exibe todos os sets de armadura marcados como favoritos pelo usuário
 */
  ...
  useEffect(() => {
    ...
    const fetchFavorites = async () => {
      ...
      try {
        ...
        const setsArray = Array.isArray(favoriteSets) ? favoriteSets : [];
        setSets(setsArray);
  ...
  const handleToggleRelation = async (
    ...
    try {
      if (isActive) {
        ...
        // Se estava removendo favorito e a página é de favoritos, remove da lista
